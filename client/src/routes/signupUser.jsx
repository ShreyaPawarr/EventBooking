                ...
                <div className="form flex flex-col bg-slate-200 gap-8 p-10 rounded-xl w-1/2">
                    ...
                    <   div className="flex flex-col justify-center items-start gap-2">
                        ...
                        <div className="flex flex-col justify-center items-start gap-2">
                            ...
                            <input onChange={inputHandler} className="w-full border-2 border-black px-4 py-2 rounded-full focus:border-[#4DC4A4]" type="number" name="age" id="age" placeholder="Enter your Age"/>
                        </div>                  
                        <div className="flex flex-col justify-center items-start gap-2">
